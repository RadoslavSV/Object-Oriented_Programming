...
class TestCase {
   ...
   public:
    ...
    string CHECKgetErrorType() const;  //write a function that will check the proper working of the function - getErrorType()

    /// Retrieve the message of the error if Error has one, otherwise return an empty string
